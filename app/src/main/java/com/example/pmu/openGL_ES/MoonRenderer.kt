...
class MoonRenderer(private val context: Context) : GLSurfaceView.Renderer {
    private lateinit var sphereFong: SphereFong
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        sphereFong = SphereFong(radius = 1.0f)
        sphereFong.initialize()
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        sphereFong.draw(mvpMatrix, normalMatrix, lightPos, textureId)
    }
